  ...
  <svg style="display: none;">
    ...
    <div class="col-container">
        ...
        <a class="logo" href="./">
          ...
          <span class="logo-name">Monitorizare Cheltuieli</span>
        </a>
      </h1>

  		<ul class="nav">
        <li class="nav-item tasks<?php if ($page == "tasks") { echo " on"; } ?>"><a class="nav-link" href="lista_facturi.php">Facturi</a></li>
        <li class="nav-item projects<?php if ($page == "projects") { echo " on"; } ?>"><a class="nav-link" href="lista_chitante.php">Chitante</a></li>
        <li class="nav-item reports<?php if ($page == "reports") { echo " on"; } ?>"><a class="nav-link" href="reports.php">Report</a></li>
      </ul>
    </div>
  </header>
	<div id="content">
